...
<template>
  <div class="min-h-screen flex items-center justify-center px-16</div>">
    <r-animation-blurry-shapes class="absolute z-0 top-1/2 animate-spin animate-duration-20000">
    </r-animation-blurry-shapes>
